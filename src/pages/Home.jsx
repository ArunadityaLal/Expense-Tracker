...
const Home = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br mt-5 from-indigo-900 via-purple-900 to-pink-800 flex items-center justify-center relative overflow-hidden">
